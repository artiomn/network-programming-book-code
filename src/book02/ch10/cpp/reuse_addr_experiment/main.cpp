...
void bind_sockets(
    const socket_wrapper::SocketWrapper &sock_wrap, const std::string &address1, const std::string &address2,
    unsigned short port, int option, const int flag, bool add_listen = false)
{
