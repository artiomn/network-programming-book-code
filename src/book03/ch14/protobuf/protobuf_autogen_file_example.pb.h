...
#define PROTOBUF_INTERNAL_EXPORT_tag_5fprovider_2eproto
    PROTOBUF_NAMESPACE_OPEN namespace internal
{
    class AnyMetadata;
}  // namespace internal
...
template <>
::our_system::tag_provider::Tag* Arena::CreateMaybeMessage<::our_system::tag_provider::Tag>(Arena*);
template <>
::our_system::tag_provider::TagBriefInfo* Arena::CreateMaybeMessage<::our_system::tag_provider::TagBriefInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace our_system
{
namespace tag_provider
...
class TagBriefInfo PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:our_system.tag_provider.TagBriefInfo)
                   */
{
public:
    ...
    TagBriefInfo(TagBriefInfo&& from) noexcept : TagBriefInfo() { *this = ::std::move(from); }
...
public:
    ...
    inline Tag* New() const final { return CreateMaybeMessage<Tag>(nullptr); }

    Tag* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final { return CreateMaybeMessage<Tag>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "our_system.tag_provider.Tag"; }
...
public:
    void unsafe_arena_set_allocated_timestamp(PROTOBUF_NAMESPACE_ID::Timestamp* timestamp);
...
public:
    void unsafe_arena_set_allocated_briefinfo(::our_system::tag_provider::TagBriefInfo* briefinfo);
...
inline void Tag::unsafe_arena_set_allocated_timestamp(PROTOBUF_NAMESPACE_ID::Timestamp* timestamp)
{
    if (GetArena() == nullptr)
    {
...
...
    ...
    // bool boolVal = 20;
    inline bool
    Tag::_internal_has_boolval() const
{
