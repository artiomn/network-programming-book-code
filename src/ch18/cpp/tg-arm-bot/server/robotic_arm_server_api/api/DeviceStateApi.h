...
protected:
    ...
    virtual int handler_PUT(std::string const& deviceId, std::string const& body);

    virtual std::pair<int, std::shared_ptr<DeviceState>> handler_GET(std::string const& deviceId);
...
protected:
    ...
    virtual void setResponseHeader(const std::shared_ptr<restbed::Session>& session, const std::string& header);


    virtual void returnResponse(
        const std::shared_ptr<restbed::Session>& session, const int status, const std::string& result,
        const std::string& contentType);
    virtual void defaultSessionClose(
        const std::shared_ptr<restbed::Session>& session, const int status, const std::string& result);
...
public:
    ...
    virtual void setDeviceStateApiDeviceDeviceIdStateResource(
        std::shared_ptr<DeviceStateApiDeviceDeviceIdStateResource> spDeviceStateApiDeviceDeviceIdStateResource);
