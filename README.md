...
- [FAQ](#faq)
  * [У вас же тут всё идеально, точно без ошибок?](#у-вас-же-тут-всё-идеально-точно-без-ошибок)
  * [Почему меня забанили?](#почему-меня-забанили)
  ...
  * [Docker - что это?](#docker---что-это)
    ...
    - [Как обновить Docker образ?](#как-обновить-docker-образ)
...
- [Для контрибьютеров](#для-контрибьютеров)
- [Контакты с авторами](#контакты-с-авторами)
...
Docker образы тоже [могут потребовать обновления](#как-обновить-docker-образ).
...
[Обновите его](#как-обновить-docker-образ).
