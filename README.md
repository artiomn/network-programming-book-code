...
**Не делайте каталог вида**: `~/Общедоступные/user/Пользователь\Артём/lessons/C++-network/Programming_Lessons & Code/Репозиторий!/*С кодом?/network-programming-book-code`.  
