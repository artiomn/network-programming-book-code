...
**Не делайте каталог вида**: `~/Общедоступные/user/Пользователь\Артём/本の宿題/C++-network/Programming_Lessons & Code/Репозиторий!/*С кодом?/network-programming-book-code`.  
